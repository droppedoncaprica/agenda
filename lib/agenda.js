...
// Job Methods
Agenda.prototype.create = function(name, data, startAt, endAt) {
...
Agenda.prototype.every = function(interval, names, data, startAt, endAt) {
  var self = this;

  if (typeof names === 'string' || names instanceof String) {
    return createJob(interval, names, data, startAt, endAt);
  } else if (Array.isArray(names)) {
    return createJobs(interval, names, data, startAt, endAt);
  }

  function createJob(interval, name, data, startAt, endAt) {
    var job = self.create(name, data, startAt, endAt);
  ...
  function createJobs(interval, names, data, startAt, endAt) {
